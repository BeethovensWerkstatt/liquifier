...
/**
 * Animate repeat symbols rendered by Thulemeier as line polygons.
 *
 ...
 * @returns {void}
 */
export function liquifyRepeats (ftSvg, dtSvg, atMeiDom, tools) {
  liquifyLinePolygons(ftSvg, dtSvg, tools, ['g.repeat', 'g.mRpt', 'g.halfmRpt', 'g.beatRpt'])
}
